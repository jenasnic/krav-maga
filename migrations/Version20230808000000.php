...
final class Version20230808000000 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE registration RENAME COLUMN use_pass15 TO use_pass_citizen, RENAME COLUMN pass15_url TO pass_citizen_url, RENAME COLUMN use_pass50 TO use_pass_sport, RENAME COLUMN pass50_url TO pass_sport_url, ADD re_enrollment TINYINT(1) NOT NULL');
